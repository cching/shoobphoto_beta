...
class DprojectsControllerTest < ActionController::TestCase
  ...
  test "should create dproject" do
    assert_difference('Dproject.count') do
      post :create, dproject: { completed_at: @dproject.completed_at, description: @dproject.description, scode: @dproject.scode }
    end
  ...
  test "should update dproject" do
    patch :update, id: @dproject, dproject: { completed_at: @dproject.completed_at, description: @dproject.description, scode: @dproject.scode }
    assert_redirected_to dproject_path(assigns(:dproject))
  end

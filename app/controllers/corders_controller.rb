...
def export
  ...
  private
    ...
    def order_params
      params.require(:corder).permit(:grade, :residential, :cart_id, :last_name, :first_name, :district, :ip_address, :schools, :school, :phone, :posted, :email, :price, :notes, :address, :city, :state, :zip_code, :card_type, :card_expires_on, :card_number, :card_verification, :shipping_state, :processed, :shipping_address, :shipping_zip, :shipping_city, :student_id, :school_id, :admin, :teacher, :parent)
    end

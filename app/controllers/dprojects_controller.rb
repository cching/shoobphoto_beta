...
class DprojectsController < ApplicationController
  ...
  private
    ...
    def dproject_params
      ...
      :note_to_lab, :delivered_by, :invoice_status, :signature, dattachments_attributes: [:id, :dproject_id, :created_at, :updated_at, :dcomment, :sfile_file_name, :sfile_content_type, :sfile_file_size, :sfile_updated_at], invoices_attributes: [:id,
